...
private:
	...
	void AddField_UInteger(gui::CVListLayout* pList, int Member, const CLocalizableString& Text);
	...
	void AddField_ZoneIndex(gui::CVListLayout* pList, int Member, int ZonePathMember, const CLocalizableString& Text);
