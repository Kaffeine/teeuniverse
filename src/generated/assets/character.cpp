...
void CAsset_Character::CPart::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_Character::CPart& SysType)
{
	SysType.m_Name = pLoadingContext->ArchiveFile()->GetString(TuaType.m_Name);
	pLoadingContext->ReadAssetPath(TuaType.m_DefaultPath, SysType.m_DefaultPath);
}
...
void CAsset_Character::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_Character& SysType)
{
	...
	pLoadingContext->ReadAssetPath(TuaType.m_UncontrolledJumpPath, SysType.m_UncontrolledJumpPath);
	{
		const CAsset_Character::CPart::CTuaType_0_3_3* pData = (const CAsset_Character::CPart::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Part.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Part.m_Size);
		SysType.m_Part.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_Character::CPart::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_Part[i]);
		}
	}
...
void CAsset_Character::CPart::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_Character::CPart& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Name = pLoadingContext->ArchiveFile()->AddString(SysType.m_Name.buffer());
	pLoadingContext->WriteAssetPath(SysType.m_DefaultPath, TuaType.m_DefaultPath);
}

void CAsset_Character::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_Character& SysType, CTuaType_0_3_3& TuaType)
{
	...
	{
		TuaType.m_Part.m_Size = SysType.m_Part.size();
		CAsset_Character::CPart::CTuaType_0_3_3* pData = new CAsset_Character::CPart::CTuaType_0_3_3[SysType.m_Part.size()];
		mem_zero(pData, sizeof(CAsset_Character::CPart::CTuaType_0_3_3)*SysType.m_Part.size());
		for(unsigned int i = 0; i < SysType.m_Part.size(); i++)
		{
			CAsset_Character::CPart::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Part[i], pData[i]);
		}
		TuaType.m_Part.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_Character::CPart::CTuaType_0_3_3)*SysType.m_Part.size());
		delete[] pData;
	}
}
