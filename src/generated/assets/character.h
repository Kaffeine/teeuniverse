...
public:
	...
	public:
		...
		public:
			tua_stringid m_Name;
			CAssetPath::CTuaType m_DefaultPath;
			static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_Character::CPart& SysType);
			static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_Character::CPart& SysType, CTuaType_0_3_3& TuaType);
		};
	...
	public:
		...
		CAssetPath::CTuaType m_UncontrolledJumpPath;
		CTuaArray m_Part;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_Character& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_Character& SysType, CTuaType_0_3_3& TuaType);
	};
