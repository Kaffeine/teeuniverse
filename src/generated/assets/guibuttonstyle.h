...
public:
	...
	public:
		...
		CAssetPath::CTuaType m_ReadOnlyStylePath;
		CAssetPath::CTuaType m_FocusStylePath;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_GuiButtonStyle& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiButtonStyle& SysType, CTuaType_0_3_3& TuaType);
	};
