...
public:
	...
	public:
		...
		CAssetPath::CTuaType m_SquareIconPath;
		CAssetPath::CTuaType m_WheelIconPath;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_GuiColorEditStyle& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiColorEditStyle& SysType, CTuaType_0_3_3& TuaType);
	};
