...
public:
	...
	public:
		CAssetPath::CTuaType m_IncreaseButtonStylePath;
		CAssetPath::CTuaType m_DecreaseButtonStylePath;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_GuiIntEditStyle& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiIntEditStyle& SysType, CTuaType_0_3_3& TuaType);
	};
