...
public:
	...
	public:
		...
		CAssetPath::CTuaType m_RectPath;
		CAssetPath::CTuaType m_IconPath;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_GuiLabelStyle& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiLabelStyle& SysType, CTuaType_0_3_3& TuaType);
	};
