...
public:
	...
	public:
		...
		CAssetPath::CTuaType m_ImageMPath;
		CAssetPath::CTuaType m_ImageRPath;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_GuiLineStyle& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiLineStyle& SysType, CTuaType_0_3_3& TuaType);
	};
