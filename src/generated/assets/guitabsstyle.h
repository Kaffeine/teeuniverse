...
public:
	...
	public:
		...
		tua_uint8 m_ButtonListFill;
		tua_uint8 m_ButtonListText;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_GuiTabsStyle& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_GuiTabsStyle& SysType, CTuaType_0_3_3& TuaType);
	};
