...
public:
	...
	public:
		...
		tua_uint8 m_TilingEnabled;
		CTuaArray2d m_Data;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_Image& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_Image& SysType, CTuaType_0_3_3& TuaType);
	};
