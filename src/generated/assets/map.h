...
public:
	...
	public:
		...
		tua_uint8 m_ShowEntities;
		tua_uint8 m_ShowZones;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_Map& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_Map& SysType, CTuaType_0_3_3& TuaType);
	};
