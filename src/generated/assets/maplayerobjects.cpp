...
void CAsset_MapLayerObjects::CObject::CTuaType_0_2_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects::CObject& SysType, CTuaType_0_2_0& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_StylePath, TuaType.m_StylePath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_2_0)*SysType.m_Vertex.size());
		...
		TuaType.m_Vertex.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_2_0)*SysType.m_Vertex.size());
		delete[] pData;
	}
...
void CAsset_MapLayerObjects::CTuaType_0_2_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects& SysType, CTuaType_0_2_0& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ParentPath, TuaType.m_ParentPath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_2_0)*SysType.m_Object.size());
		...
		TuaType.m_Object.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_2_0)*SysType.m_Object.size());
		delete[] pData;
	}
...
void CAsset_MapLayerObjects::CObject::CTuaType_0_2_1::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects::CObject& SysType, CTuaType_0_2_1& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_StylePath, TuaType.m_StylePath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_2_1)*SysType.m_Vertex.size());
		for(unsigned int i = 0; i < SysType.m_Vertex.size(); i++)
		{
			CAsset_MapLayerObjects::CVertex::CTuaType_0_2_1::Write(pLoadingContext, SysType.m_Vertex[i], pData[i]);
		}
		TuaType.m_Vertex.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_2_1)*SysType.m_Vertex.size());
		delete[] pData;
	}
	TuaType.m_PathType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_PathType);
	TuaType.m_FillType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_FillType);
...
void CAsset_MapLayerObjects::CTuaType_0_2_1::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects& SysType, CTuaType_0_2_1& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ParentPath, TuaType.m_ParentPath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_2_1)*SysType.m_Object.size());
		for(unsigned int i = 0; i < SysType.m_Object.size(); i++)
		{
			CAsset_MapLayerObjects::CObject::CTuaType_0_2_1::Write(pLoadingContext, SysType.m_Object[i], pData[i]);
		}
		TuaType.m_Object.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_2_1)*SysType.m_Object.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
}
...
void CAsset_MapLayerObjects::CObject::CTuaType_0_2_2::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects::CObject& SysType, CTuaType_0_2_2& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_StylePath, TuaType.m_StylePath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_2_2)*SysType.m_Vertex.size());
		for(unsigned int i = 0; i < SysType.m_Vertex.size(); i++)
		{
			CAsset_MapLayerObjects::CVertex::CTuaType_0_2_2::Write(pLoadingContext, SysType.m_Vertex[i], pData[i]);
		}
		TuaType.m_Vertex.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_2_2)*SysType.m_Vertex.size());
		delete[] pData;
	}
	TuaType.m_PathType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_PathType);
	TuaType.m_FillType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_FillType);
...
void CAsset_MapLayerObjects::CTuaType_0_2_2::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects& SysType, CTuaType_0_2_2& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ParentPath, TuaType.m_ParentPath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_2_2)*SysType.m_Object.size());
		for(unsigned int i = 0; i < SysType.m_Object.size(); i++)
		{
			CAsset_MapLayerObjects::CObject::CTuaType_0_2_2::Write(pLoadingContext, SysType.m_Object[i], pData[i]);
		}
		TuaType.m_Object.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_2_2)*SysType.m_Object.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
}
...
void CAsset_MapLayerObjects::CObject::CTuaType_0_2_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects::CObject& SysType, CTuaType_0_2_3& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_StylePath, TuaType.m_StylePath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_2_3)*SysType.m_Vertex.size());
		for(unsigned int i = 0; i < SysType.m_Vertex.size(); i++)
		{
			CAsset_MapLayerObjects::CVertex::CTuaType_0_2_3::Write(pLoadingContext, SysType.m_Vertex[i], pData[i]);
		}
		TuaType.m_Vertex.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_2_3)*SysType.m_Vertex.size());
		delete[] pData;
	}
	TuaType.m_PathType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_PathType);
	TuaType.m_FillType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_FillType);
...
void CAsset_MapLayerObjects::CTuaType_0_2_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects& SysType, CTuaType_0_2_3& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ParentPath, TuaType.m_ParentPath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_2_3)*SysType.m_Object.size());
		for(unsigned int i = 0; i < SysType.m_Object.size(); i++)
		{
			CAsset_MapLayerObjects::CObject::CTuaType_0_2_3::Write(pLoadingContext, SysType.m_Object[i], pData[i]);
		}
		TuaType.m_Object.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_2_3)*SysType.m_Object.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
...
void CAsset_MapLayerObjects::CObject::CTuaType_0_2_4::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects::CObject& SysType, CTuaType_0_2_4& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_StylePath, TuaType.m_StylePath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_2_4)*SysType.m_Vertex.size());
		for(unsigned int i = 0; i < SysType.m_Vertex.size(); i++)
		{
			CAsset_MapLayerObjects::CVertex::CTuaType_0_2_4::Write(pLoadingContext, SysType.m_Vertex[i], pData[i]);
		}
		TuaType.m_Vertex.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_2_4)*SysType.m_Vertex.size());
		delete[] pData;
	}
	TuaType.m_PathType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_PathType);
	TuaType.m_FillType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_FillType);
...
void CAsset_MapLayerObjects::CTuaType_0_2_4::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects& SysType, CTuaType_0_2_4& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ParentPath, TuaType.m_ParentPath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_2_4)*SysType.m_Object.size());
		for(unsigned int i = 0; i < SysType.m_Object.size(); i++)
		{
			CAsset_MapLayerObjects::CObject::CTuaType_0_2_4::Write(pLoadingContext, SysType.m_Object[i], pData[i]);
		}
		TuaType.m_Object.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_2_4)*SysType.m_Object.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
	TuaType.m_LevelOfDetail = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_LevelOfDetail);
...
void CAsset_MapLayerObjects::CObject::CTuaType_0_3_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects::CObject& SysType, CTuaType_0_3_0& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_StylePath, TuaType.m_StylePath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_3_0)*SysType.m_Vertex.size());
		for(unsigned int i = 0; i < SysType.m_Vertex.size(); i++)
		{
			CAsset_MapLayerObjects::CVertex::CTuaType_0_3_0::Write(pLoadingContext, SysType.m_Vertex[i], pData[i]);
		}
		TuaType.m_Vertex.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_3_0)*SysType.m_Vertex.size());
		delete[] pData;
	}
	TuaType.m_PathType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_PathType);
	TuaType.m_FillType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_FillType);
...
void CAsset_MapLayerObjects::CTuaType_0_3_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects& SysType, CTuaType_0_3_0& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ParentPath, TuaType.m_ParentPath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_3_0)*SysType.m_Object.size());
		for(unsigned int i = 0; i < SysType.m_Object.size(); i++)
		{
			CAsset_MapLayerObjects::CObject::CTuaType_0_3_0::Write(pLoadingContext, SysType.m_Object[i], pData[i]);
		}
		TuaType.m_Object.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_3_0)*SysType.m_Object.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
	TuaType.m_LevelOfDetail = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_LevelOfDetail);
...
void CAsset_MapLayerObjects::CVertex::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_MapLayerObjects::CVertex& SysType)
{
	SysType.m_Position.x = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Position.m_X);
	SysType.m_Position.y = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Position.m_Y);
	SysType.m_Weight = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Weight);
...
void CAsset_MapLayerObjects::CObject::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_MapLayerObjects::CObject& SysType)
{
	SysType.m_Position.x = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Position.m_X);
	SysType.m_Position.y = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Position.m_Y);
	SysType.m_Size.x = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Size.m_X);
	...
	pLoadingContext->ReadAssetPath(TuaType.m_StylePath, SysType.m_StylePath);
	{
		const CAsset_MapLayerObjects::CVertex::CTuaType_0_3_3* pData = (const CAsset_MapLayerObjects::CVertex::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Vertex.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Vertex.m_Size);
		SysType.m_Vertex.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_MapLayerObjects::CVertex::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_Vertex[i]);
		}
	}
...
void CAsset_MapLayerObjects::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_MapLayerObjects& SysType)
{
	CAsset::CTuaType_0_3_3::Read(pLoadingContext, TuaType, SysType);

	pLoadingContext->ReadAssetPath(TuaType.m_ParentPath, SysType.m_ParentPath);
	{
		const CAsset_MapLayerObjects::CObject::CTuaType_0_3_3* pData = (const CAsset_MapLayerObjects::CObject::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Object.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Object.m_Size);
		SysType.m_Object.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_MapLayerObjects::CObject::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_Object[i]);
		}
	}
...
void CAsset_MapLayerObjects::CVertex::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects::CVertex& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Position.m_X = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Position.x);
	TuaType.m_Position.m_Y = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Position.y);
	TuaType.m_Weight = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Weight);
...
void CAsset_MapLayerObjects::CObject::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects::CObject& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Position.m_X = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Position.x);
	TuaType.m_Position.m_Y = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Position.y);
	TuaType.m_Size.m_X = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Size.x);
	...
	{
		TuaType.m_Vertex.m_Size = SysType.m_Vertex.size();
		CAsset_MapLayerObjects::CVertex::CTuaType_0_3_3* pData = new CAsset_MapLayerObjects::CVertex::CTuaType_0_3_3[SysType.m_Vertex.size()];
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_3_3)*SysType.m_Vertex.size());
		for(unsigned int i = 0; i < SysType.m_Vertex.size(); i++)
		{
			CAsset_MapLayerObjects::CVertex::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Vertex[i], pData[i]);
		}
		TuaType.m_Vertex.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CVertex::CTuaType_0_3_3)*SysType.m_Vertex.size());
		delete[] pData;
	}
	TuaType.m_PathType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_PathType);
	TuaType.m_FillType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_FillType);
...
void CAsset_MapLayerObjects::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerObjects& SysType, CTuaType_0_3_3& TuaType)
{
	...
	{
		TuaType.m_Object.m_Size = SysType.m_Object.size();
		CAsset_MapLayerObjects::CObject::CTuaType_0_3_3* pData = new CAsset_MapLayerObjects::CObject::CTuaType_0_3_3[SysType.m_Object.size()];
		mem_zero(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_3_3)*SysType.m_Object.size());
		for(unsigned int i = 0; i < SysType.m_Object.size(); i++)
		{
			CAsset_MapLayerObjects::CObject::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Object[i], pData[i]);
		}
		TuaType.m_Object.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerObjects::CObject::CTuaType_0_3_3)*SysType.m_Object.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
	TuaType.m_LevelOfDetail = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_LevelOfDetail);
...
template<>
int64_t CAsset_MapLayerObjects::GetValue(int ValueType, const CSubPath& SubPath, int64_t DefaultValue) const
{
	switch(ValueType)
	{
...
template<>
bool CAsset_MapLayerObjects::SetValue(int ValueType, const CSubPath& SubPath, int64_t Value)
{
	switch(ValueType)
	{
		case OBJECT_ANIMATIONOFFSET:
