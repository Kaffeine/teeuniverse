...
void CAsset_MapLayerQuads::CTuaType_0_2_0::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_2_0& TuaType, CAsset_MapLayerQuads& SysType)
{
	...
	pLoadingContext->ReadAssetPath(TuaType.m_ImagePath, SysType.m_ImagePath);
	{
		...
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Quad.m_Size);
...
void CAsset_MapLayerQuads::CTuaType_0_2_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerQuads& SysType, CTuaType_0_2_0& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ImagePath, TuaType.m_ImagePath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_2_0)*SysType.m_Quad.size());
		...
		TuaType.m_Quad.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_2_0)*SysType.m_Quad.size());
		delete[] pData;
	}
...
void CAsset_MapLayerQuads::CTuaType_0_2_1::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerQuads& SysType, CTuaType_0_2_1& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ImagePath, TuaType.m_ImagePath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_2_1)*SysType.m_Quad.size());
		for(unsigned int i = 0; i < SysType.m_Quad.size(); i++)
		{
			CAsset_MapLayerQuads::CQuad::CTuaType_0_2_1::Write(pLoadingContext, SysType.m_Quad[i], pData[i]);
		}
		TuaType.m_Quad.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_2_1)*SysType.m_Quad.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
}
...
void CAsset_MapLayerQuads::CTuaType_0_2_2::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerQuads& SysType, CTuaType_0_2_2& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ImagePath, TuaType.m_ImagePath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_2_2)*SysType.m_Quad.size());
		for(unsigned int i = 0; i < SysType.m_Quad.size(); i++)
		{
			CAsset_MapLayerQuads::CQuad::CTuaType_0_2_2::Write(pLoadingContext, SysType.m_Quad[i], pData[i]);
		}
		TuaType.m_Quad.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_2_2)*SysType.m_Quad.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
}
...
void CAsset_MapLayerQuads::CTuaType_0_2_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerQuads& SysType, CTuaType_0_2_3& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ImagePath, TuaType.m_ImagePath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_2_3)*SysType.m_Quad.size());
		for(unsigned int i = 0; i < SysType.m_Quad.size(); i++)
		{
			CAsset_MapLayerQuads::CQuad::CTuaType_0_2_3::Write(pLoadingContext, SysType.m_Quad[i], pData[i]);
		}
		TuaType.m_Quad.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_2_3)*SysType.m_Quad.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
...
void CAsset_MapLayerQuads::CTuaType_0_2_4::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerQuads& SysType, CTuaType_0_2_4& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ImagePath, TuaType.m_ImagePath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_2_4)*SysType.m_Quad.size());
		for(unsigned int i = 0; i < SysType.m_Quad.size(); i++)
		{
			CAsset_MapLayerQuads::CQuad::CTuaType_0_2_4::Write(pLoadingContext, SysType.m_Quad[i], pData[i]);
		}
		TuaType.m_Quad.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_2_4)*SysType.m_Quad.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
	TuaType.m_LevelOfDetail = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_LevelOfDetail);
...
void CAsset_MapLayerQuads::CTuaType_0_3_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerQuads& SysType, CTuaType_0_3_0& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ImagePath, TuaType.m_ImagePath);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_3_0)*SysType.m_Quad.size());
		for(unsigned int i = 0; i < SysType.m_Quad.size(); i++)
		{
			CAsset_MapLayerQuads::CQuad::CTuaType_0_3_0::Write(pLoadingContext, SysType.m_Quad[i], pData[i]);
		}
		TuaType.m_Quad.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_3_0)*SysType.m_Quad.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
	TuaType.m_LevelOfDetail = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_LevelOfDetail);
...
void CAsset_MapLayerQuads::CQuad::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_MapLayerQuads::CQuad& SysType)
{
	SysType.m_Pivot.x = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Pivot.m_X);
	SysType.m_Pivot.y = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Pivot.m_Y);
	SysType.m_Size.x = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Size.m_X);
...
void CAsset_MapLayerQuads::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_MapLayerQuads& SysType)
{
	...
	pLoadingContext->ReadAssetPath(TuaType.m_ImagePath, SysType.m_ImagePath);
	{
		const CAsset_MapLayerQuads::CQuad::CTuaType_0_3_3* pData = (const CAsset_MapLayerQuads::CQuad::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Quad.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Quad.m_Size);
		SysType.m_Quad.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_MapLayerQuads::CQuad::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_Quad[i]);
		}
	}
...
void CAsset_MapLayerQuads::CQuad::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerQuads::CQuad& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Pivot.m_X = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Pivot.x);
	TuaType.m_Pivot.m_Y = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Pivot.y);
	TuaType.m_Size.m_X = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Size.x);
...
void CAsset_MapLayerQuads::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerQuads& SysType, CTuaType_0_3_3& TuaType)
{
	...
	{
		TuaType.m_Quad.m_Size = SysType.m_Quad.size();
		CAsset_MapLayerQuads::CQuad::CTuaType_0_3_3* pData = new CAsset_MapLayerQuads::CQuad::CTuaType_0_3_3[SysType.m_Quad.size()];
		mem_zero(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_3_3)*SysType.m_Quad.size());
		for(unsigned int i = 0; i < SysType.m_Quad.size(); i++)
		{
			CAsset_MapLayerQuads::CQuad::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Quad[i], pData[i]);
		}
		TuaType.m_Quad.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapLayerQuads::CQuad::CTuaType_0_3_3)*SysType.m_Quad.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
	TuaType.m_LevelOfDetail = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_LevelOfDetail);
...
template<>
int64_t CAsset_MapLayerQuads::GetValue(int ValueType, const CSubPath& SubPath, int64_t DefaultValue) const
{
	switch(ValueType)
	{
...
template<>
bool CAsset_MapLayerQuads::SetValue(int ValueType, const CSubPath& SubPath, int64_t Value)
{
	switch(ValueType)
	{
		case QUAD_ANIMATIONOFFSET:
