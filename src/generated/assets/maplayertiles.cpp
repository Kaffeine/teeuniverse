...
void CAsset_MapLayerTiles::CTuaType_0_2_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerTiles& SysType, CTuaType_0_2_0& TuaType)
{
	...
	TuaType.m_Color = pLoadingContext->ArchiveFile()->WriteColor(SysType.m_Color);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerTiles::CTile::CTuaType_0_2_0)*SysType.m_Tile.get_linear_size());
...
void CAsset_MapLayerTiles::CTuaType_0_2_1::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerTiles& SysType, CTuaType_0_2_1& TuaType)
{
	...
	TuaType.m_Color = pLoadingContext->ArchiveFile()->WriteColor(SysType.m_Color);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerTiles::CTile::CTuaType_0_2_1)*SysType.m_Tile.get_linear_size());
		for(int i = 0; i < SysType.m_Tile.get_linear_size(); i++)
		{
...
void CAsset_MapLayerTiles::CTuaType_0_2_2::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerTiles& SysType, CTuaType_0_2_2& TuaType)
{
	...
	TuaType.m_Color = pLoadingContext->ArchiveFile()->WriteColor(SysType.m_Color);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerTiles::CTile::CTuaType_0_2_2)*SysType.m_Tile.get_linear_size());
		for(int i = 0; i < SysType.m_Tile.get_linear_size(); i++)
		{
...
void CAsset_MapLayerTiles::CTuaType_0_2_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerTiles& SysType, CTuaType_0_2_3& TuaType)
{
	...
	TuaType.m_Color = pLoadingContext->ArchiveFile()->WriteColor(SysType.m_Color);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerTiles::CTile::CTuaType_0_2_3)*SysType.m_Tile.get_linear_size());
		for(int i = 0; i < SysType.m_Tile.get_linear_size(); i++)
		{
...
void CAsset_MapLayerTiles::CTuaType_0_2_4::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerTiles& SysType, CTuaType_0_2_4& TuaType)
{
	...
	TuaType.m_Color = pLoadingContext->ArchiveFile()->WriteColor(SysType.m_Color);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerTiles::CTile::CTuaType_0_2_4)*SysType.m_Tile.get_linear_size());
		for(int i = 0; i < SysType.m_Tile.get_linear_size(); i++)
		{
...
void CAsset_MapLayerTiles::CTuaType_0_3_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerTiles& SysType, CTuaType_0_3_0& TuaType)
{
	...
	TuaType.m_Color = pLoadingContext->ArchiveFile()->WriteColor(SysType.m_Color);
	{
		...
		mem_zero(pData, sizeof(CAsset_MapLayerTiles::CTile::CTuaType_0_3_0)*SysType.m_Tile.get_linear_size());
		for(int i = 0; i < SysType.m_Tile.get_linear_size(); i++)
		{
...
void CAsset_MapLayerTiles::CTile::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_MapLayerTiles::CTile& SysType)
{
	SysType.m_Index = pLoadingContext->ArchiveFile()->ReadUInt8(TuaType.m_Index);
	SysType.m_Flags = pLoadingContext->ArchiveFile()->ReadUInt8(TuaType.m_Flags);
	SysType.m_Brush = pLoadingContext->ArchiveFile()->ReadUInt8(TuaType.m_Brush);
...
void CAsset_MapLayerTiles::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_MapLayerTiles& SysType)
{
	...
	SysType.m_Color = pLoadingContext->ArchiveFile()->ReadColor(TuaType.m_Color);
	{
		const CAsset_MapLayerTiles::CTile::CTuaType_0_3_3* pData = (const CAsset_MapLayerTiles::CTile::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Tile.m_Data);
		uint32_t Width = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Tile.m_Width);
		uint32_t Height = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Tile.m_Height);
		uint32_t Depth = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Tile.m_Depth);
		SysType.m_Tile.resize(Width, Height, Depth);
		...
		{
			CTile ReadedValue;
			CAsset_MapLayerTiles::CTile::CTuaType_0_3_3::Read(pLoadingContext, pData[i], ReadedValue);
			SysType.m_Tile.linear_set_clamp(i, ReadedValue);
		}
	}
...
void CAsset_MapLayerTiles::CTile::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerTiles::CTile& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Index = pLoadingContext->ArchiveFile()->WriteUInt8(SysType.m_Index);
	TuaType.m_Flags = pLoadingContext->ArchiveFile()->WriteUInt8(SysType.m_Flags);
	TuaType.m_Brush = pLoadingContext->ArchiveFile()->WriteUInt8(SysType.m_Brush);
...
void CAsset_MapLayerTiles::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapLayerTiles& SysType, CTuaType_0_3_3& TuaType)
{
	...
	TuaType.m_Color = pLoadingContext->ArchiveFile()->WriteColor(SysType.m_Color);
	{
		...
		TuaType.m_Tile.m_Height = pLoadingContext->ArchiveFile()->WriteUInt32(SysType.m_Tile.get_height());
		TuaType.m_Tile.m_Depth = pLoadingContext->ArchiveFile()->WriteUInt32(SysType.m_Tile.get_depth());
		CAsset_MapLayerTiles::CTile::CTuaType_0_3_3* pData = new CAsset_MapLayerTiles::CTile::CTuaType_0_3_3[SysType.m_Tile.get_linear_size()];
		mem_zero(pData, sizeof(CAsset_MapLayerTiles::CTile::CTuaType_0_3_3)*SysType.m_Tile.get_linear_size());
		for(int i = 0; i < SysType.m_Tile.get_linear_size(); i++)
		{
			CAsset_MapLayerTiles::CTile::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Tile.linear_get_clamp(i), pData[i]);
		}
		TuaType.m_Tile.m_Data = pLoadingContext->ArchiveFile()->AddData((tua_uint8*) pData, sizeof(CAsset_MapLayerTiles::CTile::CTuaType_0_3_3)*SysType.m_Tile.get_linear_size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
	TuaType.m_PositionX = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_PositionX);
