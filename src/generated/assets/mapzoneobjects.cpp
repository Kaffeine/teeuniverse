...
void CAsset_MapZoneObjects::CVertex::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_MapZoneObjects::CVertex& SysType)
{
	SysType.m_Position.x = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Position.m_X);
	SysType.m_Position.y = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Position.m_Y);
	SysType.m_Smoothness = pLoadingContext->ArchiveFile()->ReadInt32(TuaType.m_Smoothness);
...
void CAsset_MapZoneObjects::CObject::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_MapZoneObjects::CObject& SysType)
{
	SysType.m_Position.x = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Position.m_X);
	SysType.m_Position.y = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Position.m_Y);
	SysType.m_Size.x = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Size.m_X);
	...
	SysType.m_Angle = pLoadingContext->ArchiveFile()->ReadFloat(TuaType.m_Angle);
	{
		const CAsset_MapZoneObjects::CVertex::CTuaType_0_3_3* pData = (const CAsset_MapZoneObjects::CVertex::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Vertex.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Vertex.m_Size);
		SysType.m_Vertex.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_MapZoneObjects::CVertex::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_Vertex[i]);
		}
	}
...
void CAsset_MapZoneObjects::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_MapZoneObjects& SysType)
{
	...
	pLoadingContext->ReadAssetPath(TuaType.m_ZoneTypePath, SysType.m_ZoneTypePath);
	{
		const CAsset_MapZoneObjects::CObject::CTuaType_0_3_3* pData = (const CAsset_MapZoneObjects::CObject::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Object.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Object.m_Size);
		SysType.m_Object.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_MapZoneObjects::CObject::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_Object[i]);
		}
	}
...
void CAsset_MapZoneObjects::CVertex::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapZoneObjects::CVertex& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Position.m_X = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Position.x);
	TuaType.m_Position.m_Y = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Position.y);
	TuaType.m_Smoothness = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_Smoothness);
...
void CAsset_MapZoneObjects::CObject::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapZoneObjects::CObject& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Position.m_X = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Position.x);
	TuaType.m_Position.m_Y = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Position.y);
	TuaType.m_Size.m_X = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Size.x);
	...
	{
		TuaType.m_Vertex.m_Size = SysType.m_Vertex.size();
		CAsset_MapZoneObjects::CVertex::CTuaType_0_3_3* pData = new CAsset_MapZoneObjects::CVertex::CTuaType_0_3_3[SysType.m_Vertex.size()];
		mem_zero(pData, sizeof(CAsset_MapZoneObjects::CVertex::CTuaType_0_3_3)*SysType.m_Vertex.size());
		for(unsigned int i = 0; i < SysType.m_Vertex.size(); i++)
		{
			CAsset_MapZoneObjects::CVertex::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Vertex[i], pData[i]);
		}
		TuaType.m_Vertex.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapZoneObjects::CVertex::CTuaType_0_3_3)*SysType.m_Vertex.size());
		delete[] pData;
	}
	TuaType.m_PathType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_PathType);
	TuaType.m_FillType = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_FillType);
...
void CAsset_MapZoneObjects::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapZoneObjects& SysType, CTuaType_0_3_3& TuaType)
{
	...
	{
		TuaType.m_Object.m_Size = SysType.m_Object.size();
		CAsset_MapZoneObjects::CObject::CTuaType_0_3_3* pData = new CAsset_MapZoneObjects::CObject::CTuaType_0_3_3[SysType.m_Object.size()];
		mem_zero(pData, sizeof(CAsset_MapZoneObjects::CObject::CTuaType_0_3_3)*SysType.m_Object.size());
		for(unsigned int i = 0; i < SysType.m_Object.size(); i++)
		{
			CAsset_MapZoneObjects::CObject::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Object[i], pData[i]);
		}
		TuaType.m_Object.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_MapZoneObjects::CObject::CTuaType_0_3_3)*SysType.m_Object.size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
}
