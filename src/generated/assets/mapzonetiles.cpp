...
void CAsset_MapZoneTiles::CTile::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_MapZoneTiles::CTile& SysType)
{
	SysType.m_Index = pLoadingContext->ArchiveFile()->ReadUInt8(TuaType.m_Index);
	SysType.m_Flags = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Flags);
}
...
void CAsset_MapZoneTiles::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_MapZoneTiles& SysType)
{
	...
	pLoadingContext->ReadAssetPath(TuaType.m_ZoneTypePath, SysType.m_ZoneTypePath);
	{
		const CAsset_MapZoneTiles::CTile::CTuaType_0_3_3* pData = (const CAsset_MapZoneTiles::CTile::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Tile.m_Data);
		uint32_t Width = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Tile.m_Width);
		uint32_t Height = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Tile.m_Height);
		uint32_t Depth = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Tile.m_Depth);
		SysType.m_Tile.resize(Width, Height, Depth);
		...
		{
			CTile ReadedValue;
			CAsset_MapZoneTiles::CTile::CTuaType_0_3_3::Read(pLoadingContext, pData[i], ReadedValue);
			SysType.m_Tile.linear_set_clamp(i, ReadedValue);
		}
	}
...
void CAsset_MapZoneTiles::CTile::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapZoneTiles::CTile& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Index = pLoadingContext->ArchiveFile()->WriteUInt8(SysType.m_Index);
	TuaType.m_Flags = pLoadingContext->ArchiveFile()->WriteUInt32(SysType.m_Flags);
}

void CAsset_MapZoneTiles::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_MapZoneTiles& SysType, CTuaType_0_3_3& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_ZoneTypePath, TuaType.m_ZoneTypePath);
	{
		...
		TuaType.m_Tile.m_Height = pLoadingContext->ArchiveFile()->WriteUInt32(SysType.m_Tile.get_height());
		TuaType.m_Tile.m_Depth = pLoadingContext->ArchiveFile()->WriteUInt32(SysType.m_Tile.get_depth());
		CAsset_MapZoneTiles::CTile::CTuaType_0_3_3* pData = new CAsset_MapZoneTiles::CTile::CTuaType_0_3_3[SysType.m_Tile.get_linear_size()];
		mem_zero(pData, sizeof(CAsset_MapZoneTiles::CTile::CTuaType_0_3_3)*SysType.m_Tile.get_linear_size());
		for(int i = 0; i < SysType.m_Tile.get_linear_size(); i++)
		{
			CAsset_MapZoneTiles::CTile::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Tile.linear_get_clamp(i), pData[i]);
		}
		TuaType.m_Tile.m_Data = pLoadingContext->ArchiveFile()->AddData((tua_uint8*) pData, sizeof(CAsset_MapZoneTiles::CTile::CTuaType_0_3_3)*SysType.m_Tile.get_linear_size());
		delete[] pData;
	}
	TuaType.m_Visibility = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Visibility);
	{
