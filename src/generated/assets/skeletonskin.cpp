...
void CAsset_SkeletonSkin::CTuaType_0_2_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_SkeletonSkin& SysType, CTuaType_0_2_0& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_SkeletonPath, TuaType.m_SkeletonPath);
	{
		...
		mem_zero(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_2_0)*SysType.m_Sprite.size());
		...
		TuaType.m_Sprite.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_2_0)*SysType.m_Sprite.size());
		delete[] pData;
	}
}
...
void CAsset_SkeletonSkin::CTuaType_0_2_1::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_SkeletonSkin& SysType, CTuaType_0_2_1& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_SkeletonPath, TuaType.m_SkeletonPath);
	{
		...
		mem_zero(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_2_1)*SysType.m_Sprite.size());
		for(unsigned int i = 0; i < SysType.m_Sprite.size(); i++)
		{
			CAsset_SkeletonSkin::CSprite::CTuaType_0_2_1::Write(pLoadingContext, SysType.m_Sprite[i], pData[i]);
		}
		TuaType.m_Sprite.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_2_1)*SysType.m_Sprite.size());
		delete[] pData;
	}
}
...
void CAsset_SkeletonSkin::CTuaType_0_2_2::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_SkeletonSkin& SysType, CTuaType_0_2_2& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_SkeletonPath, TuaType.m_SkeletonPath);
	{
		...
		mem_zero(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_2_2)*SysType.m_Sprite.size());
		for(unsigned int i = 0; i < SysType.m_Sprite.size(); i++)
		{
			CAsset_SkeletonSkin::CSprite::CTuaType_0_2_2::Write(pLoadingContext, SysType.m_Sprite[i], pData[i]);
		}
		TuaType.m_Sprite.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_2_2)*SysType.m_Sprite.size());
		delete[] pData;
	}
}
...
void CAsset_SkeletonSkin::CTuaType_0_2_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_SkeletonSkin& SysType, CTuaType_0_2_3& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_SkeletonPath, TuaType.m_SkeletonPath);
	{
		...
		mem_zero(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_2_3)*SysType.m_Sprite.size());
		for(unsigned int i = 0; i < SysType.m_Sprite.size(); i++)
		{
			CAsset_SkeletonSkin::CSprite::CTuaType_0_2_3::Write(pLoadingContext, SysType.m_Sprite[i], pData[i]);
		}
		TuaType.m_Sprite.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_2_3)*SysType.m_Sprite.size());
		delete[] pData;
	}
}
...
void CAsset_SkeletonSkin::CTuaType_0_2_4::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_SkeletonSkin& SysType, CTuaType_0_2_4& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_SkeletonPath, TuaType.m_SkeletonPath);
	{
		...
		mem_zero(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_2_4)*SysType.m_Sprite.size());
		for(unsigned int i = 0; i < SysType.m_Sprite.size(); i++)
		{
			CAsset_SkeletonSkin::CSprite::CTuaType_0_2_4::Write(pLoadingContext, SysType.m_Sprite[i], pData[i]);
		}
		TuaType.m_Sprite.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_2_4)*SysType.m_Sprite.size());
		delete[] pData;
	}
}
...
void CAsset_SkeletonSkin::CTuaType_0_3_0::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_SkeletonSkin& SysType, CTuaType_0_3_0& TuaType)
{
	...
	pLoadingContext->WriteAssetPath(SysType.m_SkeletonPath, TuaType.m_SkeletonPath);
	{
		...
		mem_zero(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_3_0)*SysType.m_Sprite.size());
		for(unsigned int i = 0; i < SysType.m_Sprite.size(); i++)
		{
			CAsset_SkeletonSkin::CSprite::CTuaType_0_3_0::Write(pLoadingContext, SysType.m_Sprite[i], pData[i]);
		}
		TuaType.m_Sprite.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_3_0)*SysType.m_Sprite.size());
		delete[] pData;
	}
}

void CAsset_SkeletonSkin::CSprite::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_SkeletonSkin::CSprite& SysType)
{
	pLoadingContext->ReadAssetPath(TuaType.m_SpritePath, SysType.m_SpritePath);
	CSubPath::CTuaType::Read(pLoadingContext->ArchiveFile(), TuaType.m_BonePath, SysType.m_BonePath);
	CSubPath::CTuaType::Read(pLoadingContext->ArchiveFile(), TuaType.m_LayerPath, SysType.m_LayerPath);
...
void CAsset_SkeletonSkin::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_SkeletonSkin& SysType)
{
	CAsset::CTuaType_0_3_3::Read(pLoadingContext, TuaType, SysType);

	pLoadingContext->ReadAssetPath(TuaType.m_SkeletonPath, SysType.m_SkeletonPath);
	{
		const CAsset_SkeletonSkin::CSprite::CTuaType_0_3_3* pData = (const CAsset_SkeletonSkin::CSprite::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Sprite.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Sprite.m_Size);
		SysType.m_Sprite.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_SkeletonSkin::CSprite::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_Sprite[i]);
		}
	}
...
void CAsset_SkeletonSkin::CSprite::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_SkeletonSkin::CSprite& SysType, CTuaType_0_3_3& TuaType)
{
	pLoadingContext->WriteAssetPath(SysType.m_SpritePath, TuaType.m_SpritePath);
	CSubPath::CTuaType::Write(pLoadingContext->ArchiveFile(), SysType.m_BonePath, TuaType.m_BonePath);
	CSubPath::CTuaType::Write(pLoadingContext->ArchiveFile(), SysType.m_LayerPath, TuaType.m_LayerPath);
...
void CAsset_SkeletonSkin::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_SkeletonSkin& SysType, CTuaType_0_3_3& TuaType)
{
	...
	{
		TuaType.m_Sprite.m_Size = SysType.m_Sprite.size();
		CAsset_SkeletonSkin::CSprite::CTuaType_0_3_3* pData = new CAsset_SkeletonSkin::CSprite::CTuaType_0_3_3[SysType.m_Sprite.size()];
		mem_zero(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_3_3)*SysType.m_Sprite.size());
		for(unsigned int i = 0; i < SysType.m_Sprite.size(); i++)
		{
			CAsset_SkeletonSkin::CSprite::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Sprite[i], pData[i]);
		}
		TuaType.m_Sprite.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_SkeletonSkin::CSprite::CTuaType_0_3_3)*SysType.m_Sprite.size());
		delete[] pData;
	}
}
