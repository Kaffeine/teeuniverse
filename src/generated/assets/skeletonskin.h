...
public:
	...
	public:
		...
		public:
			...
			tua_uint32 m_Color;
			tua_int32 m_Alignment;
			static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_SkeletonSkin::CSprite& SysType);
			static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_SkeletonSkin::CSprite& SysType, CTuaType_0_3_3& TuaType);
		};
	...
	public:
		CAssetPath::CTuaType m_SkeletonPath;
		CTuaArray m_Sprite;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_SkeletonSkin& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_SkeletonSkin& SysType, CTuaType_0_3_3& TuaType);
	};
