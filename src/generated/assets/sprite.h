...
public:
	...
	public:
		...
		tua_int32 m_Width;
		tua_int32 m_Height;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_Sprite& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_Sprite& SysType, CTuaType_0_3_3& TuaType);
	};
