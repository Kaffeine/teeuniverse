...
void CAsset_TilingMaterial::CZoneConverter::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_TilingMaterial::CZoneConverter& SysType)
{
	pLoadingContext->ReadAssetPath(TuaType.m_ZoneTypePath, SysType.m_ZoneTypePath);
	SysType.m_OldIndex = pLoadingContext->ArchiveFile()->ReadUInt8(TuaType.m_OldIndex);
	SysType.m_NewIndex = pLoadingContext->ArchiveFile()->ReadUInt8(TuaType.m_NewIndex);
...
void CAsset_TilingMaterial::CRule::CCondition::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_TilingMaterial::CRule::CCondition& SysType)
{
	SysType.m_Type = pLoadingContext->ArchiveFile()->ReadInt32(TuaType.m_Type);
	SysType.m_Value = pLoadingContext->ArchiveFile()->ReadInt32(TuaType.m_Value);
	SysType.m_RelPosX = pLoadingContext->ArchiveFile()->ReadInt32(TuaType.m_RelPosX);
...
void CAsset_TilingMaterial::CRule::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_TilingMaterial::CRule& SysType)
{
	{
		const CAsset_TilingMaterial::CRule::CCondition::CTuaType_0_3_3* pData = (const CAsset_TilingMaterial::CRule::CCondition::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Condition.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Condition.m_Size);
		SysType.m_Condition.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_TilingMaterial::CRule::CCondition::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_Condition[i]);
		}
	}
...
void CAsset_TilingMaterial::CIndex::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_TilingMaterial::CIndex& SysType)
{
	SysType.m_Title = pLoadingContext->ArchiveFile()->GetString(TuaType.m_Title);
}


void CAsset_TilingMaterial::CLabel::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_TilingMaterial::CLabel& SysType)
{
	SysType.m_Title = pLoadingContext->ArchiveFile()->GetString(TuaType.m_Title);
	{
		const tua_uint8* pData = (const tua_uint8*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Index.m_Data);
...
void CAsset_TilingMaterial::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_TilingMaterial& SysType)
{
	CAsset::CTuaType_0_3_3::Read(pLoadingContext, TuaType, SysType);

	pLoadingContext->ReadAssetPath(TuaType.m_ImagePath, SysType.m_ImagePath);
	{
		const CAsset_TilingMaterial::CZoneConverter::CTuaType_0_3_3* pData = (const CAsset_TilingMaterial::CZoneConverter::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_ZoneConverter.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_ZoneConverter.m_Size);
		SysType.m_ZoneConverter.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_TilingMaterial::CZoneConverter::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_ZoneConverter[i]);
		}
	}
	
	{
		const CAsset_TilingMaterial::CRule::CTuaType_0_3_3* pData = (const CAsset_TilingMaterial::CRule::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Rule.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Rule.m_Size);
		SysType.m_Rule.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_TilingMaterial::CRule::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_Rule[i]);
		}
	}
	
	{
		const CAsset_TilingMaterial::CIndex::CTuaType_0_3_3* pData = (const CAsset_TilingMaterial::CIndex::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Index.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Index.m_Size);
		SysType.m_Index.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_TilingMaterial::CIndex::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_Index[i]);
		}
	}
	
	{
		const CAsset_TilingMaterial::CLabel::CTuaType_0_3_3* pData = (const CAsset_TilingMaterial::CLabel::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Label.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Label.m_Size);
		SysType.m_Label.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_TilingMaterial::CLabel::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_Label[i]);
		}
	}
...
void CAsset_TilingMaterial::CZoneConverter::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_TilingMaterial::CZoneConverter& SysType, CTuaType_0_3_3& TuaType)
{
	pLoadingContext->WriteAssetPath(SysType.m_ZoneTypePath, TuaType.m_ZoneTypePath);
	TuaType.m_OldIndex = pLoadingContext->ArchiveFile()->WriteUInt8(SysType.m_OldIndex);
	TuaType.m_NewIndex = pLoadingContext->ArchiveFile()->WriteUInt8(SysType.m_NewIndex);
...
void CAsset_TilingMaterial::CRule::CCondition::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_TilingMaterial::CRule::CCondition& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Type = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_Type);
	TuaType.m_Value = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_Value);
	TuaType.m_RelPosX = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_RelPosX);
...
void CAsset_TilingMaterial::CRule::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_TilingMaterial::CRule& SysType, CTuaType_0_3_3& TuaType)
{
	{
		TuaType.m_Condition.m_Size = SysType.m_Condition.size();
		CAsset_TilingMaterial::CRule::CCondition::CTuaType_0_3_3* pData = new CAsset_TilingMaterial::CRule::CCondition::CTuaType_0_3_3[SysType.m_Condition.size()];
		mem_zero(pData, sizeof(CAsset_TilingMaterial::CRule::CCondition::CTuaType_0_3_3)*SysType.m_Condition.size());
		for(unsigned int i = 0; i < SysType.m_Condition.size(); i++)
		{
			CAsset_TilingMaterial::CRule::CCondition::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Condition[i], pData[i]);
		}
		TuaType.m_Condition.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_TilingMaterial::CRule::CCondition::CTuaType_0_3_3)*SysType.m_Condition.size());
		delete[] pData;
	}
	TuaType.m_Probability = pLoadingContext->ArchiveFile()->WriteFloat(SysType.m_Probability);
	TuaType.m_TileIndex = pLoadingContext->ArchiveFile()->WriteUInt8(SysType.m_TileIndex);
...
void CAsset_TilingMaterial::CIndex::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_TilingMaterial::CIndex& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Title = pLoadingContext->ArchiveFile()->AddString(SysType.m_Title.buffer());
}

void CAsset_TilingMaterial::CLabel::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_TilingMaterial::CLabel& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Title = pLoadingContext->ArchiveFile()->AddString(SysType.m_Title.buffer());
	{
		TuaType.m_Index.m_Size = SysType.m_Index.size();
...
void CAsset_TilingMaterial::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_TilingMaterial& SysType, CTuaType_0_3_3& TuaType)
{
	...
	{
		TuaType.m_ZoneConverter.m_Size = SysType.m_ZoneConverter.size();
		CAsset_TilingMaterial::CZoneConverter::CTuaType_0_3_3* pData = new CAsset_TilingMaterial::CZoneConverter::CTuaType_0_3_3[SysType.m_ZoneConverter.size()];
		mem_zero(pData, sizeof(CAsset_TilingMaterial::CZoneConverter::CTuaType_0_3_3)*SysType.m_ZoneConverter.size());
		for(unsigned int i = 0; i < SysType.m_ZoneConverter.size(); i++)
		{
			CAsset_TilingMaterial::CZoneConverter::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_ZoneConverter[i], pData[i]);
		}
		TuaType.m_ZoneConverter.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_TilingMaterial::CZoneConverter::CTuaType_0_3_3)*SysType.m_ZoneConverter.size());
		delete[] pData;
	}
	{
		TuaType.m_Rule.m_Size = SysType.m_Rule.size();
		CAsset_TilingMaterial::CRule::CTuaType_0_3_3* pData = new CAsset_TilingMaterial::CRule::CTuaType_0_3_3[SysType.m_Rule.size()];
		mem_zero(pData, sizeof(CAsset_TilingMaterial::CRule::CTuaType_0_3_3)*SysType.m_Rule.size());
		for(unsigned int i = 0; i < SysType.m_Rule.size(); i++)
		{
			CAsset_TilingMaterial::CRule::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Rule[i], pData[i]);
		}
		TuaType.m_Rule.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_TilingMaterial::CRule::CTuaType_0_3_3)*SysType.m_Rule.size());
		delete[] pData;
	}
	{
		TuaType.m_Index.m_Size = SysType.m_Index.size();
		CAsset_TilingMaterial::CIndex::CTuaType_0_3_3* pData = new CAsset_TilingMaterial::CIndex::CTuaType_0_3_3[SysType.m_Index.size()];
		mem_zero(pData, sizeof(CAsset_TilingMaterial::CIndex::CTuaType_0_3_3)*SysType.m_Index.size());
		for(unsigned int i = 0; i < SysType.m_Index.size(); i++)
		{
			CAsset_TilingMaterial::CIndex::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Index[i], pData[i]);
		}
		TuaType.m_Index.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_TilingMaterial::CIndex::CTuaType_0_3_3)*SysType.m_Index.size());
		delete[] pData;
	}
	{
		TuaType.m_Label.m_Size = SysType.m_Label.size();
		CAsset_TilingMaterial::CLabel::CTuaType_0_3_3* pData = new CAsset_TilingMaterial::CLabel::CTuaType_0_3_3[SysType.m_Label.size()];
		mem_zero(pData, sizeof(CAsset_TilingMaterial::CLabel::CTuaType_0_3_3)*SysType.m_Label.size());
		for(unsigned int i = 0; i < SysType.m_Label.size(); i++)
		{
			CAsset_TilingMaterial::CLabel::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Label[i], pData[i]);
		}
		TuaType.m_Label.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_TilingMaterial::CLabel::CTuaType_0_3_3)*SysType.m_Label.size());
		delete[] pData;
	}
}
