...
void CAsset_ZoneType::CIndex::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_ZoneType::CIndex& SysType)
{
	SysType.m_Used = pLoadingContext->ArchiveFile()->ReadBool(TuaType.m_Used);
	SysType.m_Description = pLoadingContext->ArchiveFile()->GetString(TuaType.m_Description);
	SysType.m_Color = pLoadingContext->ArchiveFile()->ReadColor(TuaType.m_Color);
...
void CAsset_ZoneType::CDataInt::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_ZoneType::CDataInt& SysType)
{
	SysType.m_Title = pLoadingContext->ArchiveFile()->GetString(TuaType.m_Title);
	SysType.m_Description = pLoadingContext->ArchiveFile()->GetString(TuaType.m_Description);
	SysType.m_DefaultValue = pLoadingContext->ArchiveFile()->ReadInt32(TuaType.m_DefaultValue);
...
void CAsset_ZoneType::CTuaType_0_3_3::Read(CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_ZoneType& SysType)
{
	CAsset::CTuaType_0_3_3::Read(pLoadingContext, TuaType, SysType);

	{
		const CAsset_ZoneType::CIndex::CTuaType_0_3_3* pData = (const CAsset_ZoneType::CIndex::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_Index.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_Index.m_Size);
		SysType.m_Index.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_ZoneType::CIndex::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_Index[i]);
		}
	}
	
	pLoadingContext->ReadAssetPath(TuaType.m_ImagePath, SysType.m_ImagePath);
	{
		const CAsset_ZoneType::CDataInt::CTuaType_0_3_3* pData = (const CAsset_ZoneType::CDataInt::CTuaType_0_3_3*) pLoadingContext->ArchiveFile()->GetData(TuaType.m_DataInt.m_Data);
		uint32_t Size = pLoadingContext->ArchiveFile()->ReadUInt32(TuaType.m_DataInt.m_Size);
		SysType.m_DataInt.resize(Size);
		for(uint32_t i = 0; i < Size; i++)
		{
			CAsset_ZoneType::CDataInt::CTuaType_0_3_3::Read(pLoadingContext, pData[i], SysType.m_DataInt[i]);
		}
	}
...
void CAsset_ZoneType::CIndex::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_ZoneType::CIndex& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Used = pLoadingContext->ArchiveFile()->WriteBool(SysType.m_Used);
	TuaType.m_Description = pLoadingContext->ArchiveFile()->AddString(SysType.m_Description.buffer());
	TuaType.m_Color = pLoadingContext->ArchiveFile()->WriteColor(SysType.m_Color);
...
void CAsset_ZoneType::CDataInt::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_ZoneType::CDataInt& SysType, CTuaType_0_3_3& TuaType)
{
	TuaType.m_Title = pLoadingContext->ArchiveFile()->AddString(SysType.m_Title.buffer());
	TuaType.m_Description = pLoadingContext->ArchiveFile()->AddString(SysType.m_Description.buffer());
	TuaType.m_DefaultValue = pLoadingContext->ArchiveFile()->WriteInt32(SysType.m_DefaultValue);
...
void CAsset_ZoneType::CTuaType_0_3_3::Write(CAssetsSaveLoadContext* pLoadingContext, const CAsset_ZoneType& SysType, CTuaType_0_3_3& TuaType)
{
	CAsset::CTuaType_0_3_3::Write(pLoadingContext, SysType, TuaType);

	{
		TuaType.m_Index.m_Size = SysType.m_Index.size();
		CAsset_ZoneType::CIndex::CTuaType_0_3_3* pData = new CAsset_ZoneType::CIndex::CTuaType_0_3_3[SysType.m_Index.size()];
		mem_zero(pData, sizeof(CAsset_ZoneType::CIndex::CTuaType_0_3_3)*SysType.m_Index.size());
		for(unsigned int i = 0; i < SysType.m_Index.size(); i++)
		{
			CAsset_ZoneType::CIndex::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_Index[i], pData[i]);
		}
		TuaType.m_Index.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_ZoneType::CIndex::CTuaType_0_3_3)*SysType.m_Index.size());
		delete[] pData;
	}
	pLoadingContext->WriteAssetPath(SysType.m_ImagePath, TuaType.m_ImagePath);
	{
		TuaType.m_DataInt.m_Size = SysType.m_DataInt.size();
		CAsset_ZoneType::CDataInt::CTuaType_0_3_3* pData = new CAsset_ZoneType::CDataInt::CTuaType_0_3_3[SysType.m_DataInt.size()];
		mem_zero(pData, sizeof(CAsset_ZoneType::CDataInt::CTuaType_0_3_3)*SysType.m_DataInt.size());
		for(unsigned int i = 0; i < SysType.m_DataInt.size(); i++)
		{
			CAsset_ZoneType::CDataInt::CTuaType_0_3_3::Write(pLoadingContext, SysType.m_DataInt[i], pData[i]);
		}
		TuaType.m_DataInt.m_Data = pLoadingContext->ArchiveFile()->AddData(pData, sizeof(CAsset_ZoneType::CDataInt::CTuaType_0_3_3)*SysType.m_DataInt.size());
		delete[] pData;
	}
	{
		TuaType.m_Group.m_Size = SysType.m_Group.size();
