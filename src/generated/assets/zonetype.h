...
public:
	...
	public:
		...
		public:
			...
			tua_uint8 m_RotationAllowed;
			tua_uint8 m_MirrorAllowed;
			static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_ZoneType::CIndex& SysType);
			static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_ZoneType::CIndex& SysType, CTuaType_0_3_3& TuaType);
		};
	...
	public:
		...
		public:
			...
			tua_int32 m_MaxValue;
			tua_int32 m_NullValue;
			static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_ZoneType::CDataInt& SysType);
			static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_ZoneType::CDataInt& SysType, CTuaType_0_3_3& TuaType);
		};
	...
	public:
		...
		CTuaArray m_DataInt;
		CTuaArray m_Group;
		static void Read(class CAssetsSaveLoadContext* pLoadingContext, const CTuaType_0_3_3& TuaType, CAsset_ZoneType& SysType);
		static void Write(class CAssetsSaveLoadContext* pLoadingContext, const CAsset_ZoneType& SysType, CTuaType_0_3_3& TuaType);
	};
